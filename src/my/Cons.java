...
class Nil extends Cons {
	public boolean equals(Object x) { return x instanceof my.Nil ? true : false; }
...
public class Cons implements Comparable<Cons> {
	...
	public boolean equals(Object x) {
		...
		else if (this instanceof my.Nil && x instanceof my.Nil) return true;
		else if (this instanceof my.Nil || x instanceof my.Nil) return false;
	...
	public int compareTo(Cons x) {
		if (x == null) return 1;
		else if (this instanceof my.Nil && x instanceof my.Nil) return 0;
		else if (this instanceof my.Nil) return -1;
		else if (x instanceof my.Nil) return 1;
		else if (this instanceof Cons && x instanceof Cons) {
			Cons a = this;
			Cons b = (Cons)x;
			if (a.head == null && b.head == null || a.head.equals(b.head)) {
